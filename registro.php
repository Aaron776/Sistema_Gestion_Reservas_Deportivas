...
<head>
    ...
    <title>SportReserve | Registro</title>
    <!-- Google Fonts -->
        ...
        <div id="registerForm" class="form-card">
            <form action="controladores/registro.php" method="POST">
                ...
                <div class="input-group">
                    ...
                    <input type="text" id="regName" name="nombre" placeholder="Nombre completo" autocomplete="name" required>
                </div>
                <div class="input-group">
                    <i class="fas fa-envelope"></i>
                    <input type="email" id="regEmail" name="email" placeholder="Correo electrónico" autocomplete="email" required>
                </div>
                <div class="input-group">
                    <i class="fas fa-phone-alt"></i>
                    <input type="tel" id="regPhone" name="telefono" placeholder="Teléfono (opcional)">
                </div>
                <div class="input-group">
                    <i class="fas fa-lock"></i>
                    <input type="password" id="regPassword" name="password" placeholder="Contraseña" autocomplete="new-password" required>
                </div>
                <div class="input-group">
                    <i class="fas fa-check-circle"></i>
                    <input type="password" id="regConfirm" name="confirmar_password" placeholder="Confirmar contraseña" required>
                </div>
                <button type="submit" class="btn-auth" id="btnRegister">Registrarse <i class="fas fa-user-plus"></i></button>
            </form>
            ...
            <div class="social-login">
                <div class="social-icon" onclick="alert('Demo: Registro con Google')"><i class="fab fa-google"></i></div>
                <div class="social-icon" onclick="alert('Demo: Registro con Facebook')"><i class="fab fa-facebook-f"></i></div>
            </div>
        </div>
    </div>
</body>
